...
const matchInit: nkruntime.MatchInitHandler = (
...
const matchJoinAttempt: nkruntime.MatchJoinAttemptHandler = (
    ctx: nkruntime.Context,
    logger: nkruntime.Logger,
    nk: nkruntime.Nakama,
...
const matchJoin: nkruntime.MatchJoinHandler = (
    ctx: nkruntime.Context,
    logger: nkruntime.Logger,
    nk: nkruntime.Nakama,
    dispatcher: nkruntime.MatchDispatcher,
...
const matchLeave: nkruntime.MatchLeaveHandler = (
    ctx: nkruntime.Context,
    logger: nkruntime.Logger,
    nk: nkruntime.Nakama,
    dispatcher: nkruntime.MatchDispatcher,
...
// Main match loop
const matchLoop: nkruntime.MatchLoopHandler = (
    ctx: nkruntime.Context,
    logger: nkruntime.Logger,
    nk: nkruntime.Nakama,
    dispatcher: nkruntime.MatchDispatcher,
...
const matchSignal: nkruntime.MatchSignalHandler = (
    ctx: nkruntime.Context,
    logger: nkruntime.Logger,
    nk: nkruntime.Nakama,
    dispatcher: nkruntime.MatchDispatcher,
    ...
    try {
        ...
        return null; // Per Nakama docs, return null on error
    }
};

// Handle match termination
const matchTerminate: nkruntime.MatchTerminateHandler = (
    ctx: nkruntime.Context,
    logger: nkruntime.Logger,
    nk: nkruntime.Nakama,
    dispatcher: nkruntime.MatchDispatcher,
...
// Handle matchmaking
const matchmakerMatched: nkruntime.MatchmakerMatchedHandler = (
    ctx: nkruntime.Context,
    logger: nkruntime.Logger,
    nk: nkruntime.Nakama,
